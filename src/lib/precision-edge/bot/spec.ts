...
export const BOT_SPEC = {
  ...
  /**
   * Legacy compatibility field. The exact DBot cadence has NO artificial
   * cooldown: opening tick T settles on T+1, and the next opening may occur
   * only at T+2. The settlement tick is never reused as an opening tick.
   */
  waitTicks: 0,

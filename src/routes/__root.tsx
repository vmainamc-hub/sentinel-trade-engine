  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/247a4304-0483-4fd3-bb79-dc9b4b14df69/id-preview-19f03aed--4f38615f-3e86-40c7-b7c0-405b7c45c1b7.lovable.app-1785287486511.png",
      },
      {
        name: "twitter:image",
        content:
...
function RootComponent() {
  ...
  useEffect(() => {
    try {
      ...
      console.warn("[RootComponent] Could not initialize auth listener:", err);
    }
  }, [router, queryClient]);
  return (
